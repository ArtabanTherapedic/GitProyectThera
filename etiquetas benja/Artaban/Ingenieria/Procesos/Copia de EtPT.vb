...
Public Class Copia_de_EtPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.Copia de EtPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Consecutivo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCopia_de_EtPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copia_de_EtPT = New Copia_de_EtPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
