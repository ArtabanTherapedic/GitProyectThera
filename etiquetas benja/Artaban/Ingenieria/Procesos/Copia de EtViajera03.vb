...
Public Class Copia_de_EtViajera03
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Copia de EtViajera03.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.Copia de EtViajera03.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idEtiqueta() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCopia_de_EtViajera03
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Copia_de_EtViajera03 = New Copia_de_EtViajera03()
        rpt.Site = Me.Site
        Return rpt
    End Function
