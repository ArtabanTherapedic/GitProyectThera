...
Class CatSalas
    ...
    Private Function Valido() As Boolean
        Valido = False
        If cbEstatus.Text <> "" And cbCategoria.Text <> "" And cbConfort.Text <> "" And cbConstruccion.Text <> "" And _
                cbLinea.Text <> "" And cbMarca.Text <> "" And cbMedida.Text <> "" And cbModelo.Text <> "" And eDesc.Text <> "" Then
            Valido = True
        Else
    ...
    Private Sub Guardar()
        Try
            ...
            End Select
            cmd.Parameters.Add("@SKU", SqlDbType.BigInt).Value = eSKU.Text
