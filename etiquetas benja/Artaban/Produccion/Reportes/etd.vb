...
Public Class etd
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_bultos() As CrystalDecisions.[Shared].IParameterField
        Get
