...
Public Class RepDestajos01
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.RepDestajos01.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepDestajos01
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepDestajos01 = New RepDestajos01()
        rpt.Site = Me.Site
        Return rpt
    End Function
