...
Public Class RepDestajos02
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.RepDestajos02.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepDestajos02
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepDestajos02 = New RepDestajos02()
        rpt.Site = Me.Site
        Return rpt
    End Function
