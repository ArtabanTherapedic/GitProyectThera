...
Public Class RepSalidasBox
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.RepSalidasBox.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepSalidasBox
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepSalidasBox = New RepSalidasBox()
        rpt.Site = Me.Site
        Return rpt
    End Function
