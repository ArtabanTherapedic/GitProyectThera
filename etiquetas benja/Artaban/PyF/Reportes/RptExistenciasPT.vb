...
Public Class RptExistenciasPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.RptExistenciasPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NS() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptExistenciasPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptExistenciasPT = New RptExistenciasPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
