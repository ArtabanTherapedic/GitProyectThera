...
Public Class RptRevEmbarque
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.RptRevEmbarque.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptRevEmbarque
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptRevEmbarque = New RptRevEmbarque()
        rpt.Site = Me.Site
        Return rpt
    End Function
