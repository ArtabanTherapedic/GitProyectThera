...
Public Class RepFiniquitosProm
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Artaban.RepFiniquitosProm.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRepFiniquitosProm
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RepFiniquitosProm = New RepFiniquitosProm()
        rpt.Site = Me.Site
        Return rpt
    End Function
