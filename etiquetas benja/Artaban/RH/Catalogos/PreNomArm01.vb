...
Public Class PreNomArm01
    ...
    Private Sub COMP_EditValueChanged(sender As System.Object, e As System.EventArgs) Handles COMP.EditValueChanged
        ...
        eTotalD.EditValue = e4Importe.EditValue + e2Importe.EditValue + e3Importe.EditValue + e4Importe.EditValue + e5Importe.EditValue + e6Importe.EditValue + e7Importe.EditValue + e8Importe.EditValue + e9Importe.EditValue + e13Importe.EditValue + e14Importe.EditValue + e15Importe.EditValue + e16Importe.EditValue + e17Importe.EditValue '+ e10Importe.EditValue '+ e11Importe.EditValue
    ...
    Public Sub Calcular(ByVal ID As String)
                        ...
                        If TypeOf (ctrl1) Is DevExpress.XtraEditors.TextEdit Then
                            ...
                            If ctrl1.Name.ToString = strCtrl Then
                                ...
                                If CType(ctrl1, DevExpress.XtraEditors.TextEdit).EditValue > 0 Then
                                    ...
                                    If ID <> 10 Then SubT = SubT + CType(ctrl1, DevExpress.XtraEditors.TextEdit).EditValue / Div
                                End If
        ...
        For X = 0 To 17 'Dias 
            ...
            For Each ctrl1 As Control In Me.Panel1.Controls
                If TypeOf (ctrl1) Is DevExpress.XtraEditors.TextEdit Then
                    If ctrl1.Name.ToString = strCtrl Then
                        If CType(ctrl1, DevExpress.XtraEditors.TextEdit).EditValue > 0 Then
                            If X <> 10 Then Destajo = Destajo + CType(ctrl1, DevExpress.XtraEditors.TextEdit).EditValue * valores(X)
                        End If
                    End If
                End If
            Next
        Next
        'If ID = 10 Then 
        '    COMP.EditValue = e10Importe.EditValue
        'End If
        If ID = 20 Then
            ...
            COMP.EditValue = e20Importe.EditValue + e21Importe.EditValue + e10Importe.EditValue
            'Exit Sub
        End If
        If ID = 10 Then
            COMP.EditValue = e20Importe.EditValue + e21Importe.EditValue + e10Importe.EditValue
        ...
        If ID = 21 Then
            ...
            'Exit Sub
        End If
        eTotDD1.EditValue = (e2TotD1.EditValue * valores(2)) + (e3TotD1.EditValue * valores(3)) + (e4TotD1.EditValue * valores(4)) + (e5TotD1.EditValue * valores(5)) + (e6TotD1.EditValue * valores(6)) + (e7TotD1.EditValue * valores(7)) + (e8TotD1.EditValue * valores(8)) + (e9TotD1.EditValue * valores(9)) + (e10TotD1.EditValue * valores(10)) + (e13TotD1.EditValue * valores(13)) + (e14TotD1.EditValue * valores(14)) + (e15TotD1.EditValue * valores(15)) + (e16TotD1.EditValue * valores(16)) + (e17TotD1.EditValue * valores(17)) + (e20TotD1.EditValue * valores(20)) + e21TotD1.EditValue
        eTotDD2.EditValue = (e2TotD2.EditValue * valores(2)) + (e3TotD2.EditValue * valores(3)) + (e4TotD2.EditValue * valores(4)) + (e5TotD2.EditValue * valores(5)) + (e6TotD2.EditValue * valores(6)) + (e7TotD2.EditValue * valores(7)) + (e8TotD2.EditValue * valores(8)) + (e9TotD2.EditValue * valores(9)) + (e10TotD2.EditValue * valores(10)) + (e13TotD2.EditValue * valores(13)) + (e14TotD2.EditValue * valores(14)) + (e15TotD2.EditValue * valores(15)) + (e16TotD2.EditValue * valores(16)) + (e17TotD2.EditValue * valores(17)) + (e20TotD2.EditValue * valores(20)) + e21TotD2.EditValue
        eTotDD3.EditValue = (e2TotD3.EditValue * valores(2)) + (e3TotD3.EditValue * valores(3)) + (e4TotD3.EditValue * valores(4)) + (e5TotD3.EditValue * valores(5)) + (e6TotD3.EditValue * valores(6)) + (e7TotD3.EditValue * valores(7)) + (e8TotD3.EditValue * valores(8)) + (e9TotD3.EditValue * valores(9)) + (e10TotD3.EditValue * valores(10)) + (e13TotD3.EditValue * valores(13)) + (e14TotD3.EditValue * valores(14)) + (e15TotD3.EditValue * valores(15)) + (e16TotD3.EditValue * valores(16)) + (e17TotD3.EditValue * valores(17)) + (e20TotD3.EditValue * valores(20)) + e21TotD3.EditValue
        eTotDD4.EditValue = (e2TotD4.EditValue * valores(2)) + (e3TotD4.EditValue * valores(3)) + (e4TotD4.EditValue * valores(4)) + (e5TotD4.EditValue * valores(5)) + (e6TotD4.EditValue * valores(6)) + (e7TotD4.EditValue * valores(7)) + (e8TotD4.EditValue * valores(8)) + (e9TotD4.EditValue * valores(9)) + (e10TotD4.EditValue * valores(10)) + (e13TotD4.EditValue * valores(13)) + (e14TotD4.EditValue * valores(14)) + (e15TotD4.EditValue * valores(15)) + (e16TotD4.EditValue * valores(16)) + (e17TotD4.EditValue * valores(17)) + (e20TotD4.EditValue * valores(20)) + e21TotD4.EditValue
        eTotDD5.EditValue = (e2TotD5.EditValue * valores(2)) + (e3TotD5.EditValue * valores(3)) + (e4TotD5.EditValue * valores(4)) + (e5TotD5.EditValue * valores(5)) + (e6TotD5.EditValue * valores(6)) + (e7TotD5.EditValue * valores(7)) + (e8TotD5.EditValue * valores(8)) + (e9TotD5.EditValue * valores(9)) + (e10TotD5.EditValue * valores(10)) + (e13TotD5.EditValue * valores(13)) + (e14TotD5.EditValue * valores(14)) + (e15TotD5.EditValue * valores(15)) + (e16TotD5.EditValue * valores(16)) + (e17TotD5.EditValue * valores(17)) + (e20TotD5.EditValue * valores(20)) + e21TotD5.EditValue
        eTotDD6.EditValue = (e2TotD6.EditValue * valores(2)) + (e3TotD6.EditValue * valores(3)) + (e4TotD6.EditValue * valores(4)) + (e5TotD6.EditValue * valores(5)) + (e6TotD6.EditValue * valores(6)) + (e7TotD6.EditValue * valores(7)) + (e8TotD6.EditValue * valores(8)) + (e9TotD6.EditValue * valores(9)) + (e10TotD6.EditValue * valores(10)) + (e13TotD6.EditValue * valores(13)) + (e14TotD6.EditValue * valores(14)) + (e15TotD6.EditValue * valores(15)) + (e16TotD6.EditValue * valores(16)) + (e17TotD6.EditValue * valores(17)) + (e20TotD6.EditValue * valores(20)) + e21TotD6.EditValue
    ...
    Private Sub Calcula0(Sender As System.Object, e As System.EventArgs)
        Calcular(0)
    End Sub

    Private Sub Calcula1(Sender As System.Object, e As System.EventArgs)
        Calcular(1)
    End Sub
    ...
    Private Sub Calcula11(Sender As System.Object, e As System.EventArgs)
        Calcular(11)
    End Sub

    Private Sub Calcula12(Sender As System.Object, e As System.EventArgs)
        Calcular(12)
    End Sub
