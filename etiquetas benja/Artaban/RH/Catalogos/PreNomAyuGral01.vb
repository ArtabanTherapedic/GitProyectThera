...
Public Class PreNomAyuGral01
    ...
    Public Sub CalculaA()
        ...
        If Not IsNothing(AD1A.EditValue) Then
            If AD1A.Text = "" Then AD1A.EditValue = 0
        ...
        If Not IsNothing(AD2A.EditValue) Then
            If AD2A.Text = "" Then AD2A.EditValue = 0
        ...
        If Not IsNothing(AD3A.EditValue) Then
            If AD3A.Text = "" Then AD3A.EditValue = 0
        ...
        If Not IsNothing(AD4A.EditValue) Then
            If AD4A.Text = "" Then AD4A.EditValue = 0
        ...
        If Not IsNothing(AD5A.EditValue) Then
            If AD5A.Text = "" Then AD5A.EditValue = 0
        ...
        If Not IsNothing(AD6A.EditValue) Then
            If AD6A.Text = "" Then AD6A.EditValue = 0
    ...
    Private Sub CalculaD()
        ...
        If Not IsNothing(DD1A.EditValue) Then
            If DD1A.Text = "" Then DD1A.EditValue = 0
            If Not IsNumeric(DD1A.EditValue) Then DD1A.EditValue = 0
        ...
        If Not IsNothing(DD2A.EditValue) Then
            If DD2A.Text = "" Then DD2A.EditValue = 0
            If Not IsNumeric(DD2A.EditValue) Then DD2A.EditValue = 0
        ...
        If Not IsNothing(DD3A.EditValue) Then
            If DD3A.Text = "" Then DD3A.EditValue = 0
            If Not IsNumeric(DD3A.EditValue) Then DD3A.EditValue = 0
        ...
        If Not IsNothing(DD4A.EditValue) Then
            If DD4A.Text = "" Then DD4A.EditValue = 0
            If Not IsNumeric(DD4A.EditValue) Then DD4A.EditValue = 0
        ...
        If Not IsNothing(DD5A.EditValue) Then
            If DD5A.Text = "" Then DD5A.EditValue = 0
            If Not IsNumeric(DD5A.EditValue) Then DD5A.EditValue = 0
        ...
        If Not IsNothing(DD6A.EditValue) Then
            If DD6A.Text = "" Then DD6A.EditValue = 0
            If Not IsNumeric(DD6A.EditValue) Then DD6A.EditValue = 0
    ...
    Private Sub CalculaC()
        ...
        If Not IsNothing(CD1A.EditValue) Then
            If CD1A.Text = "" Then CD1A.EditValue = 0
        ...
        If Not IsNothing(CD2A.EditValue) Then
            If CD2A.Text = "" Then CD2A.EditValue = 0
        ...
        If Not IsNothing(CD3A.EditValue) Then
            If CD3A.Text = "" Then CD3A.EditValue = 0
        ...
        If Not IsNothing(CD4A.EditValue) Then
            If CD4A.Text = "" Then CD4A.EditValue = 0
        ...
        If Not IsNothing(CD5A.EditValue) Then
            If CD5A.Text = "" Then CD5A.EditValue = 0
        ...
        If Not IsNothing(CD6A.EditValue) Then
            If CD6A.Text = "" Then CD6A.EditValue = 0
    ...
    Public Sub CalculaB()
        ...
        If Not IsNothing(BD1A.EditValue) Then
            If BD1A.Text = "" Then BD1A.EditValue = 0
        ...
        If Not IsNothing(BD2A.EditValue) Then
            If BD2A.Text = "" Then BD2A.EditValue = 0
        ...
        If Not IsNothing(BD3A.EditValue) Then
            If BD3A.Text = "" Then BD3A.EditValue = 0
        ...
        If Not IsNothing(BD4A.EditValue) Then
            If BD4A.Text = "" Then BD4A.EditValue = 0
        ...
        If Not IsNothing(BD5A.EditValue) Then
            If BD5A.Text = "" Then BD5A.EditValue = 0
        ...
        If Not IsNothing(BD6A.EditValue) Then
            If BD6A.Text = "" Then BD6A.EditValue = 0
